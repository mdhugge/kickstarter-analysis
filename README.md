...
We could create a clustered column graph to visulaize the realtionship between country and outcome of play campaigns. This graph would allow us to analyze which countries produce the highest number of successful play campaigns. Another graph that would provide further analysis is a clustered column graph that shows the realationship between average number of backers and the outcome of play campaigns. This chart would tell us the avergae number of backers that a successful play campaign has. 
